...
CREATE TABLE `T_APPLIANCE_OPTIMAL_SCHEDULE` (
...
CREATE TABLE `T_APPLIANCE_READINGS` (
...
CREATE TABLE `T_APPLIANCE_SCHEDULE` (
  `ID_APPLIANCE` varchar(20) NOT NULL,
...
CREATE TABLE `T_CONSUMER_TARIFFS` (
...
CREATE TABLE `T_INVERTER_FORECAST` (
...
CREATE TABLE `T_INVERTER_READINGS` (
...
CREATE TABLE `T_SASM_PARAMS` (
  `param_name` text,
  `param_value` double DEFAULT NULL,
  `param_description` text
) ;

CREATE TABLE `T_STORM_WEATHER` (
...
CREATE TABLE `T_WEATHER_READINGS` (
  `reading_date` datetime DEFAULT NULL,
  `open_weather` json DEFAULT NULL,
  `accu_weather` json DEFAULT NULL,
  `id_location` varchar(10) DEFAULT NULL
